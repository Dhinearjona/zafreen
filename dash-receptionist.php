...
<head>
    ...
    <link rel="stylesheet" href="dash-receptionist.css">
    <title>Receptionist | Zafreen Dental Clinic</title>
</head>
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="dash-receptionist.php" class="active">
    ...
    <div class="home-section">
        <nav>
            <div class="sidebar-button">
                <span class="dashboard">Receptionist</span>
            </div>

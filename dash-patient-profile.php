...
<head>
    ...
    <title>Patient Profile | Zafreen Dental Clinic</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo-details">
            <span class="logo_name"><a href="dash-patient.php"><img src="img/logo.png" /></a></span>
        </div>
        <ul class="nav-links">
            <li>
            ...
            <li>
                <a href="dash-patient-receptionist.php">
                    <i class="fa-solid fa-life-ring"></i>
                    <span class="links_name">Appointment</span>
                </a>
            </li>
            <li>
                <a href="dash-patient-profile.php" class="active">
    ...
    <section class="home-section">
        <nav>
            ...
            <div class="profile-details">
                <i class="fa-solid fa-user"></i>
                <span class="admin_name"><div class="welcome" style="margin-left: 1rem;"><?php echo "<a href='dash-patient-profile.php' style='text-decoration: none; color: var(--purple); font-weight: 800; margin: 0;'>" . $_SESSION['username']; "</a>" ?></div></span>
            </div>
        </nav>

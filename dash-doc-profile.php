...
<head>
    ...
    <link rel="stylesheet" href="dash-doc-profile.css">
    <title>Doctor Profile | Zafreen Dental Clinic</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo-details">
            <span class="logo_name"><a href="dash-doctor.php"><img src="img/logo.png" /></a></span>
        </div>
        <ul class="nav-links">
            <li>
            ...
            <li>
                <a href="dash-doc-profile.php" class="active">
    ...
    <section class="home-section">
        ...
        <div class="account">
            <div class="account-desc">
                <form action="dash-doc-profile.php" method="POST">
                    <?php
